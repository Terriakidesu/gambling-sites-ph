...
|------|--------|---------|---------|
| `hostfiles/hosts.txt` | hosts (`0.0.0.0 domain`) | 6,856 | https://raw.githubusercontent.com/Terriakidesu/gambling-sites-ph/main/hostfiles/hosts.txt |
| `hostfiles/domains.txt` | plain domains, one per line | 6,856 | https://raw.githubusercontent.com/Terriakidesu/gambling-sites-ph/main/hostfiles/domains.txt |
